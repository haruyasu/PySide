...
#
# Created: Sun Oct 08 13:27:54 2017
...
class Ui_mainDialog(object):
    def setupUi(self, mainDialog):
        ...
        mainDialog.resize(388, 174)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/linux.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        mainDialog.setWindowIcon(icon)
        self.archButton = QtGui.QPushButton(mainDialog)
        self.archButton.setGeometry(QtCore.QRect(30, 50, 91, 61))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/facebook.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.fedoraButton.setGeometry(QtCore.QRect(140, 50, 101, 61))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/linkedin.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.windowsButton.setGeometry(QtCore.QRect(260, 50, 101, 61))
        icon3 = QtGui.QIcon()
    ...
    def retranslateUi(self, mainDialog):
        ...
        self.archButton.setText(QtGui.QApplication.translate("mainDialog", "Loard Arch", None, QtGui.QApplication.UnicodeUTF8))
