...
#
# Created: Sat Oct 07 21:34:50 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/linkedin.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon1)
        self.actionOpen.setObjectName("actionOpen")
        self.actionExit = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/linux.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionAbout_Software.setIcon(icon3)
