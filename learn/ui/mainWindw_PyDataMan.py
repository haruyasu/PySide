...
#
# Created: Mon Oct 09 15:54:28 2017
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.userName.setGeometry(QtCore.QRect(20, 40, 221, 20))
        self.userName.setObjectName("userName")
        self.firstName = QtGui.QLineEdit(self.centralwidget)
        self.firstName.setGeometry(QtCore.QRect(20, 80, 221, 20))
        self.firstName.setObjectName("firstName")
        self.phoneNumber = QtGui.QLineEdit(self.centralwidget)
        self.phoneNumber.setGeometry(QtCore.QRect(270, 40, 221, 20))
        self.phoneNumber.setObjectName("phoneNumber")
        self.address = QtGui.QLineEdit(self.centralwidget)
        self.address.setGeometry(QtCore.QRect(270, 80, 221, 20))
        self.address.setObjectName("address")
        self.mainTable = QtGui.QTableWidget(self.centralwidget)
        self.mainTable.setGeometry(QtCore.QRect(20, 120, 761, 411))
