...
# Form implementation generated from reading ui file 'mainWindow_PyDataMan.ui'
#
# Created: Thu Oct 12 22:24:43 2017
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.userName.setGeometry(QtCore.QRect(20, 20, 221, 20))
        self.userName.setObjectName("userName")
        self.firstName = QtGui.QLineEdit(self.centralwidget)
        self.firstName.setGeometry(QtCore.QRect(20, 60, 221, 20))
        self.firstName.setObjectName("firstName")
        self.phoneNumber = QtGui.QLineEdit(self.centralwidget)
        self.phoneNumber.setGeometry(QtCore.QRect(270, 20, 221, 20))
        self.phoneNumber.setObjectName("phoneNumber")
        self.address = QtGui.QLineEdit(self.centralwidget)
        self.address.setGeometry(QtCore.QRect(270, 60, 221, 20))
        self.address.setObjectName("address")
        self.mainTable = QtGui.QTableWidget(self.centralwidget)
        self.mainTable.setGeometry(QtCore.QRect(20, 100, 761, 431))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/service_manager.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.mainTable.horizontalHeaderItem(0).setText(QtGui.QApplication.translate("mainWindow", "User Name", None, QtGui.QApplication.UnicodeUTF8))
